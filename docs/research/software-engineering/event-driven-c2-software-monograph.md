...
This is Pass-1 monograph depth per `docs/research/README.md`: research-structured, landmark-cited, implementation-bound. It is not a multi-year dissertation with empirical field trials. Pass-2 may deepen proofs and surveys without inventing citations.
